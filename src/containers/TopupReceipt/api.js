...
export const create = api => ({
  getPaymentReceipt: async ({transaction_id}) => {
    ...
    const body = { query: `mutation{transactionReceipt(transaction_id:"${transaction_id}"){ status success error transaction{ transaction_amount transaction_id updated_at transaction_method merchant_name status } } }` }
