...
import ChangeEmailContainer from '../../containers/ChangeEmail'
export default class ScreenChangeEmail extends Component {
  constructor (props) {
    super(props)
    this.state = {}
  }
  ...
  render () {
    return (
      <Container style={{ backgroundColor: '#fff' }}>
        ...
        <Content padder>
          <ChangeEmailContainer navigation={this.props.navigation} />
        </Content>
      </Container>
    )
  }
