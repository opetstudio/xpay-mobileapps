...
export default class index extends Component {
  ...
  render () {
    const { merchantName, status, errors, isRequest } = this.props
    return (
      <Form style={[this.props.style]}>
        ...
        <Text style={{ alignSelf: 'center', marginBottom: 5 }}>Transaction Amount (Rp)</Text>
        <Item fixedLabel regular>
          <Input keyboardType='numeric' style={{ textAlign: 'center' }} placeholder='ex. 500000' placeholderTextColor='#d3d3d3' onChangeText={this.handleOnChangeInputAmount.bind(this)} />
        </Item>
